...
<?php include '../sidebar.php'; ?>
    ...
    <div class="page-body">
        ...
        <div class="container-fluid">
            <div class="alert alert-info">
                ...
                <strong><?php _e('Important!') ?></strong>  <?php _e('Do not edit or delete any taxes if they are already used.') ?>
            </div>
            <div class="quick-card card">
                <div class="card-body">
                    <div class="dataTables_wrapper">
                        <table class="table table-striped" id="ajax_datatable" data-jsonfile="taxes.php">
                            <thead>
                            <tr>
                                <th><?php _e('Tax') ?></th>
                                <th><?php _e('Name') ?></th>
    ...
    <div class="site-action">
        <div class="site-action-buttons">
            <button type="button" id="quick-delete-button" data-action="deleteTaxes"
                    class="btn btn-danger btn-floating animation-slide-bottom">
                <i class="icon icon-feather-trash-2" aria-hidden="true"></i>
            </button>
        </div>
        <button type="button" class="front-icon btn btn-primary btn-floating" data-url="panel/taxes.php" data-toggle="slidePanel">
