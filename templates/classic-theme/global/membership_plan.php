                ...
                <form name="form1" method="post">
                    ...
                    <div class="pricing-plans-container">
                        ...
                        foreach ($sub_types as $plan) {
                            ?>
                            <!-- Plan -->
                            <div class="pricing-plan <?= (isset($plan['recommended']) && $plan['recommended'] == "yes") ? 'recommended' : ''; ?>" data-monthly-price="<?php _esc($plan['monthly_price_number']) ?>"
                                ...
                                <div class="pricing-plan-features">
                                    ...
                                    <ul>
                                        ...
                                        <?php } ?>
                                        <li>
                                            <strong><?php _esc(count((array) $plan['ai_templates'])) ?></strong> <?php _e("AI Document Templates") ?>
                                        </li>
                                        <li>
